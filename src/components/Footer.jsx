      ...
      <div className="container">
        <div className="footer-content">
          ...
          <div className="tf-social-1 justify-content-center">
            <a href="https://dribbble.com/FanzC" target="_blank" rel="noreferrer" aria-label="Dribbble" className="text-body-1 fw-semibold" onClick={playTick} onMouseEnter={playHover}>
              Dribbble
              <div className="social-item"><i className="icon icon-dribbble"></i></div>
            </a>
            <a href="https://www.behance.net/fanzcreative" target="_blank" rel="noreferrer" aria-label="Behance" className="text-body-1 fw-semibold" onClick={playTick} onMouseEnter={playHover}>
              Behance
              <div className="social-item"><i className="icon icon-behance"></i></div>
            </a>
            <a href="https://wa.me/4407378562333?text=Hello!%0AIt%E2%80%99s%20nice%20to%20meet%20you,%20and%20I%20look%20forward%20to%20working%20together!" target="_blank" rel="noreferrer" aria-label="WhatsApp" className="text-body-1 fw-semibold" onClick={playTick} onMouseEnter={playHover}>
              WhatsApp
            ...
            <a href="https://uk.trustpilot.com/review/fanzcreative.design" target="_blank" rel="noreferrer" aria-label="Trustpilot" className="text-body-1 fw-semibold" onClick={playTick} onMouseEnter={playHover} style={{ color: '#00b67a' }}>
              Trustpilot
              <div className="social-item" style={{ background: '#00b67a', borderColor: '#00b67a' }}><i className="icon icon-star-solid" style={{ color: '#fff' }}></i></div>
            </a>
          </div>
        </div>
